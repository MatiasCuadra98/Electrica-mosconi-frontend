                ...
                <nav className="flex flex-col space-y-4 mt-20">
                    <div className="gap-2 lg:flex lg:items-center items-center justify-center">
                        <div className="flex items-center justify-center">
                            <img className="w-14 h-14 rounded-full ring-2 ring-gray-300 dark:ring-gray-500 mr-2" src="https:/flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Bordered avatar"/>
                        </div>
